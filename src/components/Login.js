...
class Login extends Component {
    ...
    componentWillMount = () => {
        if (Validator.tokenIsValid(localStorage.getItem("loginToken"))) {
            Toast.make("info", "Already logged in", <p>You are already logged in.</p>);
    ...
    submitForm = () => {
        ...
        Axios.post(Config.BASE_URL + "/auth/login", { 
            ...
            Toast.make("success", "Logged in", <p>You have been successfully logged in.</p>);
            this.props.history.push("/");
                ...
                <Menu fixed='top' stackable>
                    <Container>
                        <Menu.Item as='a' header>
                            <Image src={tribeosTextLogo} style={{ marginRight: '1.5em', width: '10em' }} />
                            Investor Portal
                        </Menu.Item>
                        <Menu.Item>The Fairest, Most Profitable Advertising Marketplace Ever</Menu.Item>
                    </Container>
                </Menu>
                        ...
                        <Card fluid>
                            <Card.Content>
                                <Header as='h2' color='black' textAlign='center'>
                                    <Image src={tribeosLogo} /> <span style={{ color: "#EC8D00", marginLeft: "1%" }}>tribe</span>OS Investor Portal
                        </Header>
                                ...
                                <Message>
                                    New to us? <a rel="noopener noreferrer" target="_blank" href='https://tribeos.io/investors/'>Find out more</a>
                                </Message>
                            </Card.Content>
                        </Card>
                    </Grid.Column>
